...
void display(void) {
    ...
    // 첫번째 행
    // 재질에 diffuse만 있고 Ambient, Specular, Shininess, Emission이 없는 예제
    glPushMatrix();
    ...
    // 재질에 diffuse, Specular만 있고 Shininess가 low이며  Ambient, Emission이 없는 예제
    glPushMatrix();
    ...
    // 재질에 diffuse, Specular만 있고 Shininess가 high이며  Ambient, Emission이 없는 예제
    glPushMatrix();
    glTranslatef(1.25, 3.0, 0.0);
    glMaterialfv(GL_FRONT, GL_AMBIENT, no_mat);
    glMaterialfv(GL_FRONT, GL_DIFFUSE, mat_diffuse);
    ...
    // 두번째 행
    // 재질에  Ambient, diffuse만 있고  Specular, Shininess, Emission가 없는 예제
    glPushMatrix();
    ...
    // 재질에 diffuse, diffuse, Specular가 있고 Shininess가 high, Emission이 없는 예제
    glPushMatrix();
    glTranslatef(1.25, 0.0, 0.0);
    glMaterialfv(GL_FRONT, GL_AMBIENT, mat_ambient);
    glMaterialfv(GL_FRONT, GL_DIFFUSE, mat_diffuse);
    ...
    // 재질에 Colored Ambient, diffuse, Specular만 있고 Shininess가 high, Emission이 없는 예제
    glPushMatrix();
    glTranslatef(1.25, -3.0, 0.0);
    glMaterialfv(GL_FRONT, GL_AMBIENT, mat_ambient_color);
    glMaterialfv(GL_FRONT, GL_DIFFUSE, mat_diffuse);
    ...
    // 재질에 Colored Ambient, diffuse, Emission이 있고 Specular, Shininess는 없는 예제
    glPushMatrix();
    glTranslatef(3.75, -3.0, 0.0);
    glMaterialfv(GL_FRONT, GL_AMBIENT, mat_ambient_color);
    glMaterialfv(GL_FRONT, GL_DIFFUSE, mat_diffuse);
...
int main(int argc, char** argv) {
    ...
    glutCreateWindow("8-4. Material Property");
    myinit();
